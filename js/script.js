...
$(document).ready(function(){
  ...
  for (i = 0 ; i < allPlaces.length ; i ++) {
    ...
    placesCards.innerHTML += "<div class=\"col-12 col-sm-6 col-md-3 mb-3 mt-4\">" +
          ...
          "<img src=\"css/images/"+ allPlaces[i].places[j].thumbnail +"\"class=\"card-img-top\" alt=\">" + "<div class=\"card-body\"><h4>" + allPlaces[i].places[j].name + "</h4><img src=\"css/images/" + allPlaces[i].places[j].stars + "\"><div class=\"pt-4 d-block text-truncate\">" +  allPlaces[i].places[j].description + "</div><div class=\"text-secondary mt-2 mb-2 text-center\"><br><h4>$"+allPlaces[i].places[j].price+" per night </h4></div><div class=\"text-center mt-4\"><a id=\"showMore\" class=\"btn btn-primary text-white\">View More</a></div></div>";
    }
    } else {
    document.getElementById("searchResults").innerHTML + "<div class=\"col-12 text-center mt-4\"><h4>Sorry, we could not find accommodation that matches your search requirements.</h4></div>";
    }
    // }
    }//loop j fin
    }//loop i
